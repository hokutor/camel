...
public class DeleteSubscriptionTest extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:delete_subscriptions")
                    .to("hwcloud-eg:deleteSubscription?" +
                    ...
                    .log("Delete subscription successful")
                    .to("mock:delete_subscriptions_result");
            }
        };
    }
    ...
    public void testDeleteSubscriptions() throws Exception {
        MockEndpoint mock = getMockEndpoint("mock:delete_subscriptions_result");
